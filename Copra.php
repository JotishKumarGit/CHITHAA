...
<body>
    ...
    <!-- Product Details Section: Copra -->
    <div class="container my-5">
        <div class="row align-items-center">
            <!-- Left: Product Image -->
            <div class="col-md-6">
                <img src="./assets/img/Copra.png" class="img-fluid rounded" alt="Copra">
            </div>
            ...
            <div class="col-md-6">
                <h2>Copra</h2>
                <p>
                    Premium quality Copra, carefully dried and processed for use in cooking, oil extraction, and confectionery.
                    Naturally sourced to retain its rich flavor and nutritional value.
                </p>
                <ul>
                    <li>100% natural and organic</li>
                    <li>Rich in nutrients and flavor</li>
                    <li>Perfect for culinary and industrial uses</li>
                </ul>
