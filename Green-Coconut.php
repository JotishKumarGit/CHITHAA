...
<body>
    ...
    <section class="py-5 text-white position-relative text-center"
        ...
        <div class="container position-relative py-5">
            <h2 class="mb-3">Green Coconut</h2>
    ...
    <div class="container my-5">
        <div class="row align-items-center">
            <!-- Left: Product Image -->
            <div class="col-md-6">
                <img src="./assets/img/Green-Coconut.avif" class="img-fluid rounded" alt="Green Coconut">
            </div>
            ...
            <div class="col-md-6">
                <h2>Green Coconut</h2>
                <p>
                    Fresh and natural Green Coconut, perfect for drinking and culinary purposes.
                    Rich in electrolytes and nutrients to keep you hydrated and healthy.
                </p>
                <ul>
                    <li>100% organic and natural</li>
                    <li>Rich in vitamins and minerals</li>
                    <li>Directly sourced from farms</li>
                </ul>
