...
<body>
    ...
    <!-- Product Details Section: Coconut Leaf -->
    <div class="container my-5">
        <div class="row align-items-center">
            <!-- Left: Product Image -->
            <div class="col-md-6">
                <img src="./assets/img/Coconut-Leaf.jpg" class="img-fluid rounded" alt="Coconut Leaf">
            </div>
            ...
            <div class="col-md-6">
                <h2>Coconut Leaf</h2>
                <p>
                    Fresh and green Coconut Leaves, perfect for thatching, decorations, eco-friendly crafts, and
                    agricultural uses.
                    Sustainably sourced and versatile.
                </p>
                <ul>
                    <li>Eco-friendly and biodegradable</li>
                    <li>Perfect for thatching and crafts</li>
