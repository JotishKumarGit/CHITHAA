...
<body>
    ...
    <section class="py-5 text-white position-relative text-center"
        ...
        <div class="container position-relative py-5">
            <h2 class="mb-3">Coconut Shell</h2>
    ...
    <!-- Product Details Section: Coconut Shell -->
    <div class="container my-5">
        <div class="row align-items-center">
            <!-- Left: Product Image -->
            <div class="col-md-6">
                <img src="./assets/img/Coconut-Shell.jpg" class="img-fluid rounded" alt="Coconut Shell">
            </div>
            ...
            <div class="col-md-6">
                <h2>Coconut Shell</h2>
                <p>
                    Premium Coconut Shells, ideal for handicrafts, charcoal production, and decorative purposes.
                    Sustainably sourced and naturally strong for versatile use.
                </p>
                <ul>
                    <li>Eco-friendly and durable</li>
                    <li>Perfect for crafts, charcoal, and decoration</li>
