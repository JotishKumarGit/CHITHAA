...
<body>
    ...
    <section class="py-5 text-white position-relative text-center"
        ...
        <div class="container position-relative py-5">
            <h2 class="mb-3">Green Coconut Husk</h2>
    ...
    <!-- Product Details Section: Green Coconut Husk -->
    <div class="container my-5">
        <div class="row align-items-center">
            <!-- Left: Product Image -->
            <div class="col-md-6">
                <img src="./assets/img/Green-Husk.png" class="img-fluid rounded" alt="Green Coconut Husk">
            </div>

            <!-- Right: Product Text -->
            <div class="col-md-6">
                <h2>Green Coconut Husk</h2>
                <p>
                    Fresh Green Coconut Husk, ideal for coir production, gardening, and eco-friendly applications.
                    Naturally sourced and sustainably processed.
                </p>
                <ul>
                    <li>Eco-friendly and biodegradable</li>
                    <li>Perfect for coir and mulch</li>
                    <li>Sustainably sourced from farms</li>
                </ul>
